  ...
  return (
    ...
    >
      <div className="flex items-center justify-center">
        <div
          className={cn(
            "flex gap-1 w-full p-1 items-center justify-between rounded border transition-all",
  ...
  return (
    <div className="space-y-2 pr-3 py-3 relative ">
      ...
      >
        <ul
          className={cn(
            "flex items-center flex-col gap-1 h-full max-h-56 w-28 px-1 py-0.5 rounded",
          )}
        >
      ...
      <PopoverContent className="w-auto p-0 bg-gray-300 rounded" sideOffset={8}>
        <div className="flex gap-1">
          <Calendar
            {...props}
            id={"calendar"}
            className={cn("peer flex justify-end rounded", inputBase, className)}
            mode="single"
            selected={value}
